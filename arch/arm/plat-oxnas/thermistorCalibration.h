...
static const unsigned long TvsCnt[THERM_ENTRIES_IN_CALIB_TABLE] = {
    422,    /* == 143.37 deg C: Count == 0, R == 216 Ohms */
    346,    /* == 67.07 deg C: Count == 8, R == 1948 Ohms */
    329,    /* == 49.59 deg C: Count == 16, R == 3679 Ohms */
    319,    /* == 39.76 deg C: Count == 24, R == 5410 Ohms */
    312,    /* == 33 deg C: Count == 32, R == 7141 Ohms */
    307,    /* == 27.9 deg C: Count == 40, R == 8873 Ohms */
    303,    /* == 23.82 deg C: Count == 48, R == 10604 Ohms */
    299,    /* == 20.43 deg C: Count == 56, R == 12335 Ohms */
    297,    /* == 17.55 deg C: Count == 64, R == 14066 Ohms */
    294,    /* == 15.04 deg C: Count == 72, R == 15798 Ohms */
    292,    /* == 12.82 deg C: Count == 80, R == 17529 Ohms */
    290,    /* == 10.84 deg C: Count == 88, R == 19260 Ohms */
    288,    /* == 9.04 deg C: Count == 96, R == 20991 Ohms */
    286,    /* == 7.41 deg C: Count == 104, R == 22722 Ohms */
    285,    /* == 5.91 deg C: Count == 112, R == 24454 Ohms */
    284,    /* == 4.53 deg C: Count == 120, R == 26185 Ohms */
    282,    /* == 3.25 deg C: Count == 128, R == 27916 Ohms */
    281,    /* == 2.05 deg C: Count == 136, R == 29647 Ohms */
    280,    /* == 0.93 deg C: Count == 144, R == 31379 Ohms */
    279,    /* == -0.12 deg C: Count == 152, R == 33110 Ohms */
    278,    /* == -1.12 deg C: Count == 160, R == 34841 Ohms */
    277,    /* == -2.06 deg C: Count == 168, R == 36572 Ohms */
    276,    /* == -2.95 deg C: Count == 176, R == 38304 Ohms */
    275,    /* == -3.8 deg C: Count == 184, R == 40035 Ohms */
    274,    /* == -4.6 deg C: Count == 192, R == 41766 Ohms */
    274,    /* == -5.37 deg C: Count == 200, R == 43497 Ohms */
    273,    /* == -6.11 deg C: Count == 208, R == 45229 Ohms */
    272,    /* == -6.81 deg C: Count == 216, R == 46960 Ohms */
    272,    /* == -7.49 deg C: Count == 224, R == 48691 Ohms */
    271,    /* == -8.14 deg C: Count == 232, R == 50422 Ohms */
    270,    /* == -8.77 deg C: Count == 240, R == 52154 Ohms */
    270,    /* == -9.37 deg C: Count == 248, R == 53885 Ohms */
    269,    /* == -9.95 deg C: Count == 256, R == 55616 Ohms */
    268,    /* == -10.52 deg C: Count == 264, R == 57347 Ohms */
    268,    /* == -11.06 deg C: Count == 272, R == 59078 Ohms */
    267,    /* == -11.59 deg C: Count == 280, R == 60810 Ohms */
    267,    /* == -12.1 deg C: Count == 288, R == 62541 Ohms */
    266,    /* == -12.59 deg C: Count == 296, R == 64272 Ohms */
    266,    /* == -13.07 deg C: Count == 304, R == 66003 Ohms */
    265,    /* == -13.53 deg C: Count == 312, R == 67735 Ohms */
    265,    /* == -13.99 deg C: Count == 320, R == 69466 Ohms */
    265,    /* == -14.43 deg C: Count == 328, R == 71197 Ohms */
    264,    /* == -14.86 deg C: Count == 336, R == 72928 Ohms */
    264,    /* == -15.27 deg C: Count == 344, R == 74660 Ohms */
    263,    /* == -15.68 deg C: Count == 352, R == 76391 Ohms */
    263,    /* == -16.08 deg C: Count == 360, R == 78122 Ohms */
    263,    /* == -16.46 deg C: Count == 368, R == 79853 Ohms */
    262,    /* == -16.84 deg C: Count == 376, R == 81585 Ohms */
    262,    /* == -17.21 deg C: Count == 384, R == 83316 Ohms */
    261,    /* == -17.57 deg C: Count == 392, R == 85047 Ohms */
    261,    /* == -17.92 deg C: Count == 400, R == 86778 Ohms */
    261,    /* == -18.26 deg C: Count == 408, R == 88510 Ohms */
    260,    /* == -18.6 deg C: Count == 416, R == 90241 Ohms */
    260,    /* == -18.93 deg C: Count == 424, R == 91972 Ohms */
    260,    /* == -19.25 deg C: Count == 432, R == 93703 Ohms */
    259,    /* == -19.57 deg C: Count == 440, R == 95434 Ohms */
    259,    /* == -19.88 deg C: Count == 448, R == 97166 Ohms */
    259,    /* == -20.18 deg C: Count == 456, R == 98897 Ohms */
    259,    /* == -20.48 deg C: Count == 464, R == 100628 Ohms */
    258,    /* == -20.77 deg C: Count == 472, R == 102359 Ohms */
    258,    /* == -21.06 deg C: Count == 480, R == 104091 Ohms */
    258,    /* == -21.34 deg C: Count == 488, R == 105822 Ohms */
    257,    /* == -21.62 deg C: Count == 496, R == 107553 Ohms */
    257,    /* == -21.89 deg C: Count == 504, R == 109284 Ohms */
    257,    /* == -22.16 deg C: Count == 512, R == 111016 Ohms */
    257,    /* == -22.42 deg C: Count == 520, R == 112747 Ohms */
    256,    /* == -22.68 deg C: Count == 528, R == 114478 Ohms */
    256,    /* == -22.93 deg C: Count == 536, R == 116209 Ohms */
    256,    /* == -23.18 deg C: Count == 544, R == 117941 Ohms */
    256,    /* == -23.43 deg C: Count == 552, R == 119672 Ohms */
    255,    /* == -23.67 deg C: Count == 560, R == 121403 Ohms */
    255,    /* == -23.91 deg C: Count == 568, R == 123134 Ohms */
    255,    /* == -24.14 deg C: Count == 576, R == 124866 Ohms */
    255,    /* == -24.37 deg C: Count == 584, R == 126597 Ohms */
    254,    /* == -24.6 deg C: Count == 592, R == 128328 Ohms */
    254,    /* == -24.82 deg C: Count == 600, R == 130059 Ohms */
    254,    /* == -25.04 deg C: Count == 608, R == 131790 Ohms */
    254,    /* == -25.26 deg C: Count == 616, R == 133522 Ohms */
    254,    /* == -25.47 deg C: Count == 624, R == 135253 Ohms */
    253,    /* == -25.68 deg C: Count == 632, R == 136984 Ohms */
    253,    /* == -25.89 deg C: Count == 640, R == 138715 Ohms */
    253,    /* == -26.1 deg C: Count == 648, R == 140447 Ohms */
    253,    /* == -26.3 deg C: Count == 656, R == 142178 Ohms */
    253,    /* == -26.5 deg C: Count == 664, R == 143909 Ohms */
    252,    /* == -26.69 deg C: Count == 672, R == 145640 Ohms */
    252,    /* == -26.89 deg C: Count == 680, R == 147372 Ohms */
    252,    /* == -27.08 deg C: Count == 688, R == 149103 Ohms */
    252,    /* == -27.27 deg C: Count == 696, R == 150834 Ohms */
    252,    /* == -27.46 deg C: Count == 704, R == 152565 Ohms */
    251,    /* == -27.64 deg C: Count == 712, R == 154297 Ohms */
    251,    /* == -27.82 deg C: Count == 720, R == 156028 Ohms */
    251,    /* == -28 deg C: Count == 728, R == 157759 Ohms */
    251,    /* == -28.18 deg C: Count == 736, R == 159490 Ohms */
    251,    /* == -28.36 deg C: Count == 744, R == 161222 Ohms */
    250,    /* == -28.53 deg C: Count == 752, R == 162953 Ohms */
    250,    /* == -28.7 deg C: Count == 760, R == 164684 Ohms */
    250,    /* == -28.87 deg C: Count == 768, R == 166415 Ohms */
    250,    /* == -29.04 deg C: Count == 776, R == 168146 Ohms */
    250,    /* == -29.21 deg C: Count == 784, R == 169878 Ohms */
    250,    /* == -29.37 deg C: Count == 792, R == 171609 Ohms */
    249,    /* == -29.53 deg C: Count == 800, R == 173340 Ohms */
    249,    /* == -29.69 deg C: Count == 808, R == 175071 Ohms */
    249,    /* == -29.85 deg C: Count == 816, R == 176803 Ohms */
    249,    /* == -30.01 deg C: Count == 824, R == 178534 Ohms */
    249,    /* == -30.16 deg C: Count == 832, R == 180265 Ohms */
    249,    /* == -30.32 deg C: Count == 840, R == 181996 Ohms */
    249,    /* == -30.47 deg C: Count == 848, R == 183728 Ohms */
    248,    /* == -30.62 deg C: Count == 856, R == 185459 Ohms */
    248,    /* == -30.77 deg C: Count == 864, R == 187190 Ohms */
    248,    /* == -30.92 deg C: Count == 872, R == 188921 Ohms */
    248,    /* == -31.06 deg C: Count == 880, R == 190653 Ohms */
    248,    /* == -31.21 deg C: Count == 888, R == 192384 Ohms */
    248,    /* == -31.35 deg C: Count == 896, R == 194115 Ohms */
    248,    /* == -31.49 deg C: Count == 904, R == 195846 Ohms */
    247,    /* == -31.63 deg C: Count == 912, R == 197578 Ohms */
    247,    /* == -31.77 deg C: Count == 920, R == 199309 Ohms */
    247,    /* == -31.91 deg C: Count == 928, R == 201040 Ohms */
    247,    /* == -32.04 deg C: Count == 936, R == 202771 Ohms */
    247,    /* == -32.18 deg C: Count == 944, R == 204502 Ohms */
    247,    /* == -32.31 deg C: Count == 952, R == 206234 Ohms */
    247,    /* == -32.44 deg C: Count == 960, R == 207965 Ohms */
    246,    /* == -32.58 deg C: Count == 968, R == 209696 Ohms */
    246,    /* == -32.71 deg C: Count == 976, R == 211427 Ohms */
    246,    /* == -32.83 deg C: Count == 984, R == 213159 Ohms */
    246,    /* == -32.96 deg C: Count == 992, R == 214890 Ohms */
    246,    /* == -33.09 deg C: Count == 1000, R == 216621 Ohms */
    246,    /* == -33.21 deg C: Count == 1008, R == 218352 Ohms */
    246,    /* == -33.34 deg C: Count == 1016, R == 220084 Ohms */
};

#else	/* CONFIG_ZyXEL_STG211 */
