...
extern atomic_t  SATA_hd_read_write[2];
extern atomic_t  SATA_State_Counter[2];
extern struct device* sdisk_gendev[2];
...
int ata_scsi_queuecmd(struct scsi_cmnd *cmd, void (*done)(struct scsi_cmnd *))
{
	...
	if(likely(!((cmd->cmnd[0] == 0x1b) || cmd->cmnd[0] == 0x35)))
	{
		sdev = &scsidev->sdev_gendev;
		for(i = 0 ; i < 2 ; i++)
		{
